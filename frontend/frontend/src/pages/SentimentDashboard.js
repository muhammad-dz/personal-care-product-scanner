...
const SentimentDashboard = () => {
  ...
  const fetchSentimentData = async () => {
    try {
      ...
      setError("We're having trouble loading the review data right now");
      console.error(err);
    } finally {
      setLoading(false);
    }
  ...
  if (loading) {
    return (
      <div style={{ textAlign: 'center', padding: '50px' }}>
        <p>Loading customer sentiment data...</p>
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h2 style={{ color: '#333', marginBottom: '20px' }}>What People Are Saying</h2>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <h3 style={{ color: '#666', margin: '0 0 10px', fontSize: '16px' }}>Reviews Analyzed</h3>
        ...
        <div style={{
          ...
          <h3 style={{ color: '#666', margin: '0 0 10px', fontSize: '16px' }}>Overall Sentiment</h3>
          <p style={{ fontSize: '32px', fontWeight: 'bold', margin: 0, color: '#2c3e50' }}>
      ...
      <div style={{
        ...
        <h3 style={{ color: '#333', marginTop: 0 }}>Sentiment Breakdown</h3>
      ...
      <div style={{
        ...
        <h3 style={{ color: '#333', marginTop: 0 }}>Most Common Complaints</h3>
        ...
        <div>
          {sentimentData.top_issues.map((issue, index) => (
            <div key={index} style={{
              ...
              <span style={{ flex: 1, textTransform: 'capitalize' }}>{issue.issue}</span>
              <span style={{ 
                background: '#e0e0e0', 
                padding: '2px 10px', 
                borderRadius: '3px',
